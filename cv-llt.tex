...
\leftheader{%
  ...
  {\normalsize PhD candidate (Spring 2026) in \textbf{Condensed Matter Physics} specializing in data science, \textbf{computational modeling} and \textbf{X-ray and neutron scattering} with \textbf{6 years of experience} in experimental design, structural characterization, and algorithm development.}
}
