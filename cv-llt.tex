...
\leftheader{%
  ...
  {\normalsize PhD in \textbf{Condensed Matter Physics} specializing in \textbf{computational modeling} and \textbf{X-ray and neutron scattering} with \textbf{6 years of experience} in experimental design, structural characterization, and algorithm development.}
}
