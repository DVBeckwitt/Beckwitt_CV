...
\leftheader{%
  ...
  \makefield{\faOrcid}{\href{https://orcid.org/0000-0000-0000-0000}{\texttt{ORCID}}}
    { Ph.D. candidate developing quantitative diffraction simulation tools and machine learning models to analyze crystalline disorder in 2D van der Waals materials; skilled in X-ray/neutron scattering, CVD thin-film growth, and computational modeling of structural defects.
}
}
